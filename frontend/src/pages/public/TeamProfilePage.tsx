...
import { ChevronRight, MessageSquare, Award, FileText } from 'lucide-react';
...
export const TeamProfilePage: React.FC = () => {
  ...
  // Compute stats
  const totalScore = scores.reduce((sum, s) => sum + s.scoreValue, 0);
  
  // Format data for Recharts Radar Chart (0 to 100 percentage points)
  ...
  return (
    <div className="w-full space-y-8 pb-12" dir="rtl">
      ...
      {/* Main Grid: Visual performance vs detailed scores list */}
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        
        {/* Left 1 Column: Radar Chart visualization */}
        {radarData.length > 0 && (
        ...
        {/* Right 2 Columns: Score matrix breakdown progress meters */}
